...
export const EXPANSION_AUGMENTS: AugmentDef[] = [
  ...
  { id: 'team_diversity', grade: 'S', iconId: 'combat_all_stats', name: '다채로운 팀워크', description: '활성 특성 하나당 아군 공격력·주문력 +2. 최대 6개 특성.', activeTraitScaling: true, teamEffects: [add('attackDamage', 2), add('abilityPower', 2)] },
  ...
  { id: 'clear_stable', grade: 'S', iconId: 'xp_small', name: '정돈된 마방', description: 'PvP 종료 시 대기석이 비어 있으면 경험치 +2. 장비·기물은 전투 시작 당시 기준.', teamEffects: [], roundReward: { condition: 'EMPTY_BENCH', xp: 2 } },
  { id: 'crowded_stable', grade: 'G', iconId: 'bench_expand', name: '북적이는 훈련장', description: 'PvP 종료 시 대기석에 기물이 5명 이상이면 경험치 +3. 전투 시작 당시 기준.', teamEffects: [], roundReward: { condition: 'FULL_BENCH', xp: 3 } },
