...
const RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    description:
      '방어력 +25, 마법저항력 +25. 발주 6초 뒤 방어력과 마법저항력 +25를 추가로 얻는다. 경주당 1회.',
  },
  {
    id: 'steadfast_heart',
    name: '굳건한 하트',
  ...
  },
  {
    ...
    description:
      '마법저항력 +25, 치명타 확률 +15%, 공격속도 +20%. 발주 6초간 군중제어 면역. 이후 군중제어 지속시간 35% 감소.',
  },
  {
  ...
  },
  {
    ...
    description: '전략가 전용. 팀 최대 규모 +1. 발주와 동시에 아군 전체 이동속도 +10%(10초).',
  },
  {
    id: 'trainer_shield',
    name: '트레이너 방패',
